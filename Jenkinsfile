pipeline {
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                git branch: 'master', url: 'https://github.com/mahimadod/lms-notification-service.git'
            }
        }
        ...
        stage('Deploy') {
            steps {
                ...
                sh """
                    ...
                    docker run -d --name notification lms-notification -p 8087:8087 ${DOCKER_IMAGE}:${BUILD_NUMBER}
                """
            }
        }
    }
